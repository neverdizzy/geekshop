...
public class OrderOptions {
     ...
     * adding or removing an item) will require GeekShop to loop through all million items
     ...
     *
     * Attempting to exceed this limit will cause GeekShop to throw a {@link OrderItemsLimitError}.
     *
     * @default 999
     */
