...
import io.geekshop.service.helpers.input.CreateAdministratorAndUserInput;
 ...
 * external {@link io.geekshop.config.auth.AuthenticationStrategy}
 *
...
public class ExternalAuthenticationService {
     ...
     * Customer record in GeekShop for that user. This method encapsulates that logic as well as additional
     ...
     * Administrator record in GeekShop for that user.
     */
    @Transactional
