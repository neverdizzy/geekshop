...
create index  IF NOT EXISTS  idx_user_identifier on tb_user(identifier);

create table IF NOT EXISTS tb_auth_method (
    id bigint not null auto_increment,
...
create table IF NOT EXISTS tb_user_role_join (
     id bigint not null auto_increment,
     user_id bigint not null ,
...
create table IF NOT EXISTS tb_customer_group_join (
     id bigint not null auto_increment,
     customer_id bigint not null,
...
create table IF NOT EXISTS tb_facet (
     id bigint not null auto_increment,
     name varchar(50) not null,
     code varchar(50) not null,
...
create table IF NOT EXISTS tb_facet_value (
     id bigint not null auto_increment,
     name varchar(50) not null,
     code varchar(50) not null,
...
create table IF NOT EXISTS tb_customer_history_entry (
    id bigint not null auto_increment,
...
create table IF NOT EXISTS tb_order_history_entry (
    id bigint not null auto_increment,
    administrator_id bigint,
    type varchar(50) not null,
    private_only boolean,
...
create table IF NOT EXISTS tb_product_option_group_join (
   id bigint not null auto_increment,
...
create table IF NOT EXISTS tb_product_asset_join (
   id bigint not null auto_increment,
   product_id bigint not null,
...
create table IF NOT EXISTS tb_product_facet_value_join (
   id bigint not null auto_increment,
   created_by varchar(50),
   created_at datetime,
   updated_by varchar(50),
...
create table IF NOT EXISTS tb_product_variant_asset_join (
   id bigint not null auto_increment,
...
create table IF NOT EXISTS tb_product_variant_product_option_join (
   id bigint not null auto_increment,
   product_variant_id bigint not null,
...
create table IF NOT EXISTS tb_product_variant_facet_value_join (
   id bigint not null auto_increment,
   product_variant_id bigint not null,
   facet_value_id bigint not null,
   created_by varchar(50),
...
create table IF NOT EXISTS tb_product_variant_collection_join (
   id bigint not null auto_increment,
   product_variant_id bigint not null,
...
create table IF NOT EXISTS tb_collection_asset_join (
   id bigint not null auto_increment,
   collection_id bigint not null,
   asset_id bigint not null,
   position bigint,
...
create table IF NOT EXISTS tb_shipping_method (
   id bigint not null auto_increment,
   code varchar(50),
   description text,
   deleted_at datetime,
...
create table IF NOT EXISTS tb_order_promotion_join (
    id bigint not null auto_increment,
    order_id bigint not null,
...
create table IF NOT EXISTS tb_fulfillment (
    id bigint not null auto_increment,
...
create table IF NOT EXISTS tb_search_index_item (
    product_variant_id bigint not null,
    product_id bigint,
    enabled boolean,
