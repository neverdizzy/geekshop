...
package io.geekshop.e2e;

import io.geekshop.*;
import io.geekshop.config.TestConfig;
import io.geekshop.config.payment.TestErrorPaymentMethod;
import io.geekshop.config.payment.TestFailingPaymentMethod;
import io.geekshop.config.payment.TestSuccessfulPaymentMethod;
...
import io.geekshop.utils.TestHelper;
...
public class ShopOrderTest {
    ...
    public void activeOrder_returns_null_before_any_items_have_been_added() throws IOException {
        ...
        io.geekshop.types.order.Order activeOrder =
                graphQLResponse.get("$.data.activeOrder", io.geekshop.types.order.Order.class);
    ...
    public void transitionOrderToState_throws_for_an_invalid_state() throws IOException {
        ...
        try {
            ...
            assertThat(apiEx.getErrorMessage()).isEqualTo(
                    "No enum constant io.geekshop.service.helpers.order_state_machine.OrderState.Completed"
            );
        }
    }
